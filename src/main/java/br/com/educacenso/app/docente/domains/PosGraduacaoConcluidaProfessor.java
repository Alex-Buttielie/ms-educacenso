...
import br.com.educacenso.app.pessoa.constraints.TipoPosGraduacao;
...
@NoArgsConstructor
@Builder
public class PosGraduacaoConcluidaProfessor implements Serializable {
    ...
    @JoinColumn()
    @JsonFormat
    private AreaPosGraduacao areaPosGraduacao1;
    @Basic
    ...
    @JoinColumn()
    @JsonFormat
    private AreaPosGraduacao areaPosGraduacao2;
    @Basic
    ...
    @JoinColumn()
    @JsonFormat
    private AreaPosGraduacao areaPosGraduacao3;
    @Basic
    ...
    @JoinColumn()
    @JsonFormat
    private AreaPosGraduacao areaPosGraduacao4;
    @Basic
    ...
    @JoinColumn()
    @JsonFormat
    private AreaPosGraduacao areaPosGraduacao5;
    @Basic
    ...
    @JoinColumn()
    @JsonFormat
    private AreaPosGraduacao areaPosGraduacao6;
    @Basic
