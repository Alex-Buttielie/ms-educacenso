...
import br.com.educacenso.app.unidadeEnsino.constraints.FormaOcupacaoPredio;
import br.com.educacenso.app.unidadeEnsino.domains.AbastecimentoAgua;
import br.com.educacenso.app.unidadeEnsino.domains.AcessoInternet;
import br.com.educacenso.app.unidadeEnsino.domains.DependenciasFisicas;
import br.com.educacenso.app.unidadeEnsino.domains.DestinacaoLixo;
import br.com.educacenso.app.unidadeEnsino.domains.EquipamentosExistentesUnidade;
import br.com.educacenso.app.unidadeEnsino.domains.EquipamentosUsadosAlunosAcessoInternet;
import br.com.educacenso.app.unidadeEnsino.domains.EscolasComQualCompartilha;
import br.com.educacenso.app.unidadeEnsino.domains.EsgotamentoSanitario;
import br.com.educacenso.app.unidadeEnsino.domains.FonteEnergiaEletrica;
import br.com.educacenso.app.unidadeEnsino.domains.IdiomaEnsino;
import br.com.educacenso.app.unidadeEnsino.domains.InstrumentosMateriaisSocioCulturais;
import br.com.educacenso.app.unidadeEnsino.domains.LinguaIndigena;
import br.com.educacenso.app.unidadeEnsino.domains.LocalFuncionamentoEscola;
import br.com.educacenso.app.unidadeEnsino.domains.OrgaosColegiadosFuncionamentoEscola;
import br.com.educacenso.app.unidadeEnsino.domains.QuantidadeComputadoresEmUsoAlunos;
import br.com.educacenso.app.unidadeEnsino.domains.QuantidadeEquipamentosProcessoAprendizagem;
import br.com.educacenso.app.unidadeEnsino.domains.RecursoPessoasDeficientes;
import br.com.educacenso.app.unidadeEnsino.domains.RedeLocalInterligacaoComputadores;
import br.com.educacenso.app.unidadeEnsino.domains.ReservaVagasSistemaCotas;
import br.com.educacenso.app.unidadeEnsino.domains.TotalProfissionaisAtivosEscola;
import br.com.educacenso.app.unidadeEnsino.domains.TratamentoLixo;
